...
var builder = Host.CreateDefaultBuilder().ConfigureServices(services =>
{
    ...
    services.AddDbContext<DataContext>(x => x.UseSqlServer(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\Albul\Desktop\DataBase_ConsoleApp-main\ConsoleApp\Data\Local_database.mdf;Integrated Security=True;Connect Timeout=30"));
